"""
LeNet-5 model definition - Original AvgPool version

Reference: Y. LeCun et al., "Gradient-Based Learning Applied to Document Recognition", 1998.

This version uses average pooling (AvgPool2d) as in the original paper.
...
class LeNet5Avg(nn.Module):
   """LeNet-5 with average pooling (original paper setting)"""
   ...
   def __init__(self, num_classes: int = 10):
       ...
       self.relu1 = nn.ReLU()
       # S2: Avg pooling 1 - 6@14x14
       self.pool1 = nn.AvgPool2d(kernel_size=2, stride=2)

       # C3: Conv layer 2 - 16@10x10
       self.conv2 = nn.Conv2d(in_channels=6, out_channels=16, kernel_size=5)
       self.relu2 = nn.ReLU()
       # S4: Avg pooling 2 - 16@5x5
...
def lenet5_avg(num_classes: int = 10) -> LeNet5Avg:
   """Factory function for LeNet-5 (AvgPool version)"""
   return LeNet5Avg(num_classes=num_classes)
